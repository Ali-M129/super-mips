...
```text
benchmarks/dependent.asm
benchmarks/dependent.regs.hex
```
...
./scripts/run_benchmark.sh benchmarks/dependent.asm
```
...
logs/benchmarks/dependent.log
out/benchmarks/dependent.vcd
out/benchmarks/dependent.lst
```
